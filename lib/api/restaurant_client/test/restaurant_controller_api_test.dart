...
/// tests for RestaurantControllerApi
void main() {
  ...
  group('tests for RestaurantControllerApi', () {
    ...
    test('test findFiredEmployeeByBranchCode', () async {
      // TODO
    });

    //Future fireEmployee(int employeeId) async
    test('test fireEmployee', () async {
      // TODO
    });
    ...
    test('test getReportsByBranchCodeAndDate', () async {
      // TODO
    });

    //Future hideEmployee(int employeeId) async
    test('test hideEmployee', () async {
      // TODO
    });
    ...
    test('test loginFromMobileDevice', () async {
      // TODO
    });
