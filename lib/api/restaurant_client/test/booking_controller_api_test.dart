...
void main() {
  // final instance = BookingControllerApi();

  group('tests for BookingControllerApi', () {
    //Future<BookingDTO> create(BookingDTO bookingDTO) async
    test('test create', () async {
      // TODO
    });

    //Future deleteBooking(String bookingCode) async
    ...
    test('test findBookingByFormCode', () async {
      // TODO
    });
