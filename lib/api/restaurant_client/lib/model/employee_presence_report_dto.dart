...
class EmployeePresenceReportDTO {
  ...
  @override
  String toString() => 'EmployeePresenceReportDTO[reportId=$reportId, branchCode=$branchCode, employee=$employee, date=$date, workedHours=$workedHours, note=$note, presentAtDinner=$presentAtDinner, illness=$illness, presentAtLunch=$presentAtLunch, holiday=$holiday, rest=$rest]';
